...
class SignupUsingFaceBook extends StatefulWidget {

  final String userId , userImg , userName , userEmail ;

  const SignupUsingFaceBook({Key? key,required this.userId ,required this.userImg,required this.userName,required this.userEmail}) : super(key: key);
  @override
  _SignupUsingFaceBookState createState() => _SignupUsingFaceBookState();
}

enum UserType { PARENT, DRIVER }
enum Gender { male, female }

class _SignupUsingFaceBookState extends State<SignupUsingFaceBook> {
  ...
  void initState() {
    ...
    uploadedFileURL = widget.userImg;
